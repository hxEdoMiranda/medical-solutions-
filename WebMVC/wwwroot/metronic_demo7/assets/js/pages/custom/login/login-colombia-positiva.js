...
var KTLoginGeneral = function () {
    ...
    var handleSignInFormSubmit = function () {
        $('#kt_login_signin_submit').click(function (e) {
            ...
            form.ajaxSubmit({
                url: '/account/loginPositivaExterno',
                    ...
                    if (jsonResponse.err) {
                        switch (jsonResponse.err) {
                            case 1:
                                ...
                                break;
                            case 3:
                                showErrorMsg(form, 'danger', 'Usuario inactivo, ¿Necesitas ayuda? Escríbenos a contactocolombia@medismart.live o llámanos al +57 3132136751.');
                                break;
                            default:
