...
var KTLoginGeneral = function () {
    ...
    showErrorMsgCURP = function ( type, msg) {
            ...
            form.ajaxSubmit({
                ...
                success: function (response, status, xhr, $form) {
                    if (response.msg == "error") {
                        ...
                        setTimeout(function () {
                            btn.removeClass('kt-spinner kt-spinner--right kt-spinner--sm kt-spinner--light').attr('disabled', false).removeAttr('style');
                            showErrorMsg(form, 'danger', 'Usuario inactivo, contactese con mesa de ayuda para solucionar este problema, envia un correo a ayuda@medismart.live o escribiendo al +56 9 4804 2543');
                        }, 1000);
                    }
                    else
    ...
    return {
        ...
        init: function () {
            ...
            if ($("#kt_rut").length > 0) {
                document.querySelector("#kt_rut").onblur = async () => {
