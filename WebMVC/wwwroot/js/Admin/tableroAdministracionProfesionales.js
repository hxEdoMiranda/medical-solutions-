...
import { getResumenConvenio, getConvenios } from '../apis/convenios-fetch.js'
...
export async function init(data) {
    ...
    document.querySelector('[id="idPersonaEmpresa"]').textContent = EmpresaCentroClinico.idPersonaEmpresa;
