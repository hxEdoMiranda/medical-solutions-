...
const uri = baseUrl + '/agendamientos/VwHorasMedicosCentroClinico';
...
export async function generarHorasMedicoConvenioCentroClinico(formData) {

    try {
        let response = await fetch(`${uri}/generarHorasMedicoConvenioCentroClinico`, {
            method: 'POST',
            body: formData
        });
        let responseJson = await response.json();
