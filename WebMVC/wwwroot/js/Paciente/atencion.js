...
export async function init(data) {
    ...
    if ($("#volverSalaEspera").length) {
        ...
        btnVolverSala.onclick = () => {
            document.getElementById("cont-vc").setAttribute('class', 'kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid medismart-atencion d-none')
            document.getElementById("sala").setAttribute('class', 'container-fluid sala-espera d-none d-lg-block');
            if ($(".sala-espera-mobile").length) {
                document.getElementById("sala-mobile").setAttribute('class', 'container-fluid sala-espera-mobile d-lg-none');
            }
        }
    }
