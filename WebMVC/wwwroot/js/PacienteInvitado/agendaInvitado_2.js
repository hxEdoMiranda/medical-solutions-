...
export async function init(dataMedico) {
    ...
    if (codigoPaisValida == "CO") {
        ...
        UrlTerminosyCondiciones = "/TerminosyCondicionesUnab/Terminos_y_Condiciones_VF.pdf";
    }
    ...
    if (codigoPais == "CO") {
        ...
        urlConsentimiento = "/TerminosyCondicionesUnab/Consentimiento_Informado_VF.pdf";
    }
    if (consentimiento) {
    ...
    async function cargarInfoMedico(medico) {
        ...
        if (!window.host.includes("prevenciononcologica.") && !window.host.includes("saludproteccion") && !window.host.includes("clinicamundoscotia.")) {
            // Cuenta personal
        ...
        buttonInside1.href = "/AgendarInvitado?tipo=medicina";
